...
class GoogleClient extends BaseClient {
  ...
  createLLM(clientOptions) {
    ...
    if (this.project_id && this.isTextModel) {
      ...
      return new GenAI(this.apiKey).getGenerativeModel({ ...clientOptions, model }, {...requestOptions, ...this.options.customHeaders && { 'customHeaders': this.options.customHeaders }});
    }
